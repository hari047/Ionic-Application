...
public class CancellationTokenSource implements Closeable {
    ...
    private void cancelAfter(long r6, java.util.concurrent.TimeUnit r8) {
        ...
        L_0x0019:
            ...
            monitor-enter(r1)
            boolean r0 = r5.cancellationRequested     // Catch:{ all -> 0x0022 }
        ...
        L_0x0025:
            ...
            java.util.concurrent.ScheduledExecutorService r0 = r5.executor     // Catch:{ all -> 0x0022 }
            bolts.CancellationTokenSource$1 r2 = new bolts.CancellationTokenSource$1     // Catch:{ all -> 0x0022 }
            r2.<init>()     // Catch:{ all -> 0x0022 }
            java.util.concurrent.ScheduledFuture r0 = r0.schedule(r2, r6, r8)     // Catch:{ all -> 0x0022 }
