...
class TooltipPopup {
    ...
    TooltipPopup(Context context) {
        ...
        this.mContentView = LayoutInflater.from(this.mContext).inflate(C0239R.layout.tooltip, null);
        this.mMessageView = (TextView) this.mContentView.findViewById(C0239R.C0241id.message);
        ...
        this.mLayoutParams.windowAnimations = C0239R.style.Animation_AppCompat_Tooltip;
    ...
    private void computePosition(View anchorView, int anchorX, int anchorY, boolean fromTouch, LayoutParams outParams) {
        ...
        int offsetAbove;
        int statusBarHeight;
        int tooltipPreciseAnchorThreshold = this.mContext.getResources().getDimensionPixelOffset(C0239R.dimen.tooltip_precise_anchor_threshold);
        ...
        if (anchorView.getHeight() >= tooltipPreciseAnchorThreshold) {
            int offsetExtra = this.mContext.getResources().getDimensionPixelOffset(C0239R.dimen.tooltip_precise_anchor_extra_offset);
        ...
        int tooltipOffset = this.mContext.getResources().getDimensionPixelOffset(fromTouch ? C0239R.dimen.tooltip_y_offset_touch : C0239R.dimen.tooltip_y_offset_non_touch);
        ...
        if (this.mTmpDisplayFrame.left < 0 && this.mTmpDisplayFrame.top < 0) {
            ...
            int resourceId = res.getIdentifier("status_bar_height", "dimen", Constants.PLATFORM);
            if (resourceId != 0) {
