...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    public SearchView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.mSearchSrcTextView = (SearchAutoComplete) findViewById(C0239R.C0241id.search_src_text);
        this.mSearchSrcTextView.setSearchView(this);
        this.mSearchEditFrame = findViewById(C0239R.C0241id.search_edit_frame);
        this.mSearchPlate = findViewById(C0239R.C0241id.search_plate);
        this.mSubmitArea = findViewById(C0239R.C0241id.submit_area);
        this.mSearchButton = (ImageView) findViewById(C0239R.C0241id.search_button);
        this.mGoButton = (ImageView) findViewById(C0239R.C0241id.search_go_btn);
        this.mCloseButton = (ImageView) findViewById(C0239R.C0241id.search_close_btn);
        this.mVoiceButton = (ImageView) findViewById(C0239R.C0241id.search_voice_btn);
        this.mCollapsedIcon = (ImageView) findViewById(C0239R.C0241id.search_mag_icon);
