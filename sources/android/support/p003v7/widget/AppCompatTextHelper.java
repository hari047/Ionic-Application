...
class AppCompatTextHelper {
    ...
    public void loadFromAttributes(AttributeSet attrs, int defStyleAttr) {
        ...
        if (ap != -1) {
            TintTypedArray a2 = TintTypedArray.obtainStyledAttributes(context, ap, C0239R.styleable.TextAppearance);
            if (!hasPwdTm && a2.hasValue(C0239R.styleable.TextAppearance_textAllCaps)) {
                allCapsSet = true;
                allCaps = a2.getBoolean(C0239R.styleable.TextAppearance_textAllCaps, false);
            }
            updateTypefaceAndStyle(context, a2);
            if (VERSION.SDK_INT < 23) {
                if (a2.hasValue(C0239R.styleable.TextAppearance_android_textColor)) {
                    textColor = a2.getColorStateList(C0239R.styleable.TextAppearance_android_textColor);
                }
                if (a2.hasValue(C0239R.styleable.TextAppearance_android_textColorHint)) {
                    textColorHint = a2.getColorStateList(C0239R.styleable.TextAppearance_android_textColorHint);
                }
                if (a2.hasValue(C0239R.styleable.TextAppearance_android_textColorLink)) {
                    textColorLink = a2.getColorStateList(C0239R.styleable.TextAppearance_android_textColorLink);
                }
            }
            a2.recycle();
        }
        TintTypedArray a3 = TintTypedArray.obtainStyledAttributes(context, attrs, C0239R.styleable.TextAppearance, defStyleAttr, 0);
        if (!hasPwdTm && a3.hasValue(C0239R.styleable.TextAppearance_textAllCaps)) {
            allCapsSet = true;
            allCaps = a3.getBoolean(C0239R.styleable.TextAppearance_textAllCaps, false);
        }
        if (VERSION.SDK_INT < 23) {
            if (a3.hasValue(C0239R.styleable.TextAppearance_android_textColor)) {
                textColor = a3.getColorStateList(C0239R.styleable.TextAppearance_android_textColor);
            }
            if (a3.hasValue(C0239R.styleable.TextAppearance_android_textColorHint)) {
                textColorHint = a3.getColorStateList(C0239R.styleable.TextAppearance_android_textColorHint);
            }
            if (a3.hasValue(C0239R.styleable.TextAppearance_android_textColorLink)) {
                textColorLink = a3.getColorStateList(C0239R.styleable.TextAppearance_android_textColorLink);
            }
        }
