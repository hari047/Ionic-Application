...
class AppCompatDelegateImplV9 extends AppCompatDelegateImplBase implements Callback, Factory2 {
    ...
    private ViewGroup createSubDecor() {
        ...
        if (this.mWindowNoTitle) {
            ...
            this.mDecorContentParent = (DecorContentParent) subDecor.findViewById(C0239R.C0241id.decor_content_parent);
        ...
        if (this.mDecorContentParent == null) {
            this.mTitleView = (TextView) subDecor.findViewById(C0239R.C0241id.title);
        }
        ViewUtils.makeOptionalFitsSystemWindows(subDecor);
        ContentFrameLayout contentView = (ContentFrameLayout) subDecor.findViewById(C0239R.C0241id.action_bar_activity_content);
        ...
        if (mode != null) {
            ...
            if (this.mActionModeView == null) {
                if (this.mIsFloating) {
                    ...
                    ViewStubCompat stub = (ViewStubCompat) this.mSubDecor.findViewById(C0239R.C0241id.action_mode_bar_stub);
                    if (stub != null) {
