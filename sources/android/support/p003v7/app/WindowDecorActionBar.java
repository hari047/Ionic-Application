...
public class WindowDecorActionBar extends ActionBar implements ActionBarVisibilityCallback {
    ...
    private void init(View decor) {
        boolean homeAsUp;
        boolean z;
        this.mOverlayLayout = (ActionBarOverlayLayout) decor.findViewById(C0239R.C0241id.decor_content_parent);
        if (this.mOverlayLayout != null) {
            this.mOverlayLayout.setActionBarVisibilityCallback(this);
        }
        this.mDecorToolbar = getDecorToolbar(decor.findViewById(C0239R.C0241id.action_bar));
        this.mContextView = (ActionBarContextView) decor.findViewById(C0239R.C0241id.action_context_bar);
        this.mContainerView = (ActionBarContainer) decor.findViewById(C0239R.C0241id.action_bar_container);
