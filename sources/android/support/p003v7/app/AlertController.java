...
class AlertController {
    ...
    private void setupView() {
        View parentPanel = this.mWindow.findViewById(C0239R.C0241id.parentPanel);
        View defaultTopPanel = parentPanel.findViewById(C0239R.C0241id.topPanel);
        View defaultContentPanel = parentPanel.findViewById(C0239R.C0241id.contentPanel);
        View defaultButtonPanel = parentPanel.findViewById(C0239R.C0241id.buttonPanel);
        ViewGroup customPanel = (ViewGroup) parentPanel.findViewById(C0239R.C0241id.customPanel);
        setupCustomContent(customPanel);
        View customTopPanel = customPanel.findViewById(C0239R.C0241id.topPanel);
        View customContentPanel = customPanel.findViewById(C0239R.C0241id.contentPanel);
        View customButtonPanel = customPanel.findViewById(C0239R.C0241id.buttonPanel);
        ...
        if (!hasButtonPanel && contentPanel != null) {
            View spacer = contentPanel.findViewById(C0239R.C0241id.textSpacerNoButtons);
            if (spacer != null) {
        ...
        if (hasTopPanel) {
            ...
            if (!(this.mMessage == null && this.mListView == null)) {
                divider = topPanel.findViewById(C0239R.C0241id.titleDividerNoCustom);
            }
            if (divider != null) {
                divider.setVisibility(0);
            }
        } else if (contentPanel != null) {
            View spacer2 = contentPanel.findViewById(C0239R.C0241id.textSpacerNoTitle);
            if (spacer2 != null) {
    ...
    private void setScrollIndicators(ViewGroup contentPanel, View content, int indicators, int mask) {
        View indicatorUp = this.mWindow.findViewById(C0239R.C0241id.scrollIndicatorUp);
        View indicatorDown = this.mWindow.findViewById(C0239R.C0241id.scrollIndicatorDown);
    ...
    private void setupCustomContent(ViewGroup customPanel) {
        ...
        if (hasCustomView) {
            FrameLayout custom = (FrameLayout) this.mWindow.findViewById(C0239R.C0241id.custom);
    ...
    private void setupTitle(ViewGroup topPanel) {
        ...
        if (this.mCustomTitleView != null) {
            ...
            this.mWindow.findViewById(C0239R.C0241id.title_template).setVisibility(8);
            return;
        }
        ...
        this.mTitleView = (TextView) this.mWindow.findViewById(C0239R.C0241id.alertTitle);
    ...
    private void setupContent(ViewGroup contentPanel) {
        this.mScrollView = (NestedScrollView) this.mWindow.findViewById(C0239R.C0241id.scrollView);
