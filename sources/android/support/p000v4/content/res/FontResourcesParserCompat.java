...
public class FontResourcesParserCompat {
    ...
    private static FontFileResourceEntry readFont(XmlPullParser parser, Resources resources) throws XmlPullParserException, IOException {
        ...
        int weight = array.getInt(array.hasValue(C0005R.styleable.FontFamilyFont_fontWeight) ? C0005R.styleable.FontFamilyFont_fontWeight : C0005R.styleable.FontFamilyFont_android_fontWeight, NORMAL_WEIGHT);
        if (1 != array.getInt(array.hasValue(C0005R.styleable.FontFamilyFont_fontStyle) ? C0005R.styleable.FontFamilyFont_fontStyle : C0005R.styleable.FontFamilyFont_android_fontStyle, 0)) {
            isItalic = false;
        }
        int resourceAttr = array.hasValue(C0005R.styleable.FontFamilyFont_font) ? C0005R.styleable.FontFamilyFont_font : C0005R.styleable.FontFamilyFont_android_font;
