            ...
            new AsyncTask<Void, Void, Throwable>() {
                ...
                public java.lang.Throwable doInBackground(java.lang.Void... r13) {
                    ...
                    L_0x00f1:
                        ...
                        goto L_0x0078
                    */
                    throw new UnsupportedOperationException("Method not decompiled: android.support.p000v4.print.PrintHelper.PrintHelperApi19.C01502.doInBackground(java.lang.Void[]):java.lang.Throwable");
                }
                        ...
                        this.mLoadBitmap = new AsyncTask<Uri, Boolean, Bitmap>() {
                            ...
                            public void onPreExecute() {
                                cancellationSignal2.setOnCancelListener(new OnCancelListener() {
                                    public void onCancel() {
                                        C01513.this.cancelLoad();
                                        C01521.this.cancel(false);
                                    }
                                });
                            }
                            ...
                            public void onPostExecute(Bitmap bitmap) {
                                ...
                                if (bitmap != null && (!PrintHelperApi19.this.mPrintActivityRespectsOrientation || PrintHelperApi19.this.mOrientation == 0)) {
                                    synchronized (this) {
                                        mediaSize = C01513.this.mAttributes.getMediaSize();
                                    }
