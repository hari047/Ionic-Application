...
public class SplashScreen extends CordovaPlugin {
    ...
    public boolean execute(String action, JSONArray args, CallbackContext callbackContext) throws JSONException {
        if (action.equals(MessengerShareContentUtility.SHARE_BUTTON_HIDE)) {
            this.cordova.getActivity().runOnUiThread(new Runnable() {
                public void run() {
                    SplashScreen.this.webView.postMessage("splashscreen", MessengerShareContentUtility.SHARE_BUTTON_HIDE);
                }
            });
    ...
    public Object onMessage(String id, Object data) {
        if (!HAS_BUILT_IN_SPLASH_SCREEN) {
            if ("splashscreen".equals(id)) {
                if (MessengerShareContentUtility.SHARE_BUTTON_HIDE.equals(data.toString())) {
