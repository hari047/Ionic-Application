...
public class CordovaInterfaceImpl implements CordovaInterface {
        ...
        if (this.savedResult != null) {
            ...
            if (pluginManager2 != null) {
                ...
                if (appPlugin != null) {
                    ...
                    try {
                        obj.put(NativeProtocol.WEB_DIALOG_ACTION, "resume");
    ...
    public boolean onActivityResult(int requestCode, int resultCode, Intent intent) {
        ...
        this.activityResultCallback = null;
        if (callback != null) {
            LOG.m7d(TAG, "Sending activity result to plugin");
            this.initCallbackService = null;
            this.savedResult = null;
            callback.onActivityResult(requestCode, resultCode, intent);
            return true;
        }
        LOG.m19w(TAG, "Got an activity result, but no plugin was registered to receive it" + (this.savedResult != null ? " yet!" : "."));
        return false;
    }
