...
public class SystemWebViewEngine implements CordovaWebViewEngine {
    ...
    private void initWebViewSettings() {
        ...
        try {
            ...
            LOG.m7d(TAG, "CordovaWebView is running on device made by: " + Build.MANUFACTURER);
            ...
            LOG.m7d(TAG, "We are on a modern version of Android, we will deprecate HTC 2.3 devices in 2.8");
        } catch (IllegalArgumentException e2) {
            LOG.m7d(TAG, "Doing the NavDump failed with bad arguments");
        } catch (IllegalAccessException e3) {
            LOG.m7d(TAG, "This should never happen: IllegalAccessException means this isn't Android anymore");
        } catch (InvocationTargetException e4) {
            LOG.m7d(TAG, "This should never happen: InvocationTargetException means this isn't Android anymore.");
        }
    ...
    private void enableRemoteDebugging() {
        try {
            ...
            LOG.m7d(TAG, "You have one job! To turn on Remote Web Debugging! YOU HAVE FAILED! ");
            e.printStackTrace();
        }
    }
    ...
    private static void exposeJsInterface(WebView webView2, CordovaBridge bridge2) {
        if (VERSION.SDK_INT < 17) {
            LOG.m13i(TAG, "Disabled addJavascriptInterface() bridge since Android version is old.");
        } else {
    ...
    public void destroy() {
        ...
        if (this.receiver != null) {
            try {
                ...
                LOG.m11e(TAG, "Error unregistering configuration receiver: " + e.getMessage(), (Throwable) e);
            }
        }
    }
    ...
    public void evaluateJavascript(String js, ValueCallback<String> callback) {
        if (VERSION.SDK_INT >= 19) {
            ...
            LOG.m7d(TAG, "This webview is using the old bridge");
        }
    }
}
