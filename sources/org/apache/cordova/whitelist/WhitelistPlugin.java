    ...
    private class CustomConfigXmlParser extends ConfigXmlParser {
        ...
        public void handleStartTag(XmlPullParser xml) {
            ...
            if (strNode.equals("content")) {
                ...
                String origin = xml.getAttributeValue(null, ShareConstants.WEB_DIALOG_PARAM_HREF);
                if ("*".equals(origin)) {
                ...
                WhitelistPlugin.this.allowedIntents.addWhiteListEntry(xml.getAttributeValue(null, ShareConstants.WEB_DIALOG_PARAM_HREF), false);
                ...
                if (external) {
                    LOG.m19w(WhitelistPlugin.LOG_TAG, "Found <access launch-external> within config.xml. Please use <allow-intent> instead.");
                    Whitelist access$200 = WhitelistPlugin.this.allowedIntents;
                    if (subdomains == null || subdomains.compareToIgnoreCase(ServerProtocol.DIALOG_RETURN_SCOPES_TRUE) != 0) {
                        z = false;
                    }
