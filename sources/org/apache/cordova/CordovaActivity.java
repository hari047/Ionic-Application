...
public class CordovaActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        LOG.m13i(TAG, "Apache Cordova native platform version 7.0.0 is starting");
        LOG.m7d(TAG, "CordovaActivity.onCreate()");
        if (!this.preferences.getBoolean("ShowTitle", false)) {
            getWindow().requestFeature(1);
        }
        if (this.preferences.getBoolean("SetFullscreen", false)) {
            LOG.m7d(TAG, "The SetFullscreen configuration is deprecated in favor of Fullscreen, and will be removed in a future version.");
    ...
    public void onPause() {
        super.onPause();
        LOG.m7d(TAG, "Paused the activity.");
        if (this.appView != null) {
    ...
    public void onResume() {
        super.onResume();
        LOG.m7d(TAG, "Resumed the activity.");
        if (this.appView != null) {
    ...
    public void onStop() {
        super.onStop();
        LOG.m7d(TAG, "Stopped the activity.");
        if (this.appView != null) {
    ...
    public void onStart() {
        super.onStart();
        LOG.m7d(TAG, "Started the activity.");
        if (this.appView != null) {
    ...
    public void onDestroy() {
        LOG.m7d(TAG, "CordovaActivity.onDestroy()");
        super.onDestroy();
        if (this.appView != null) {
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent intent) {
        LOG.m7d(TAG, "Incoming Result. Request code = " + requestCode);
    ...
    public void onRequestPermissionsResult(int requestCode, String[] permissions, int[] grantResults) {
        try {
            ...
            LOG.m7d(TAG, "JSONException: Parameters fed into the method are not valid");
            e.printStackTrace();
        }
    }
}
