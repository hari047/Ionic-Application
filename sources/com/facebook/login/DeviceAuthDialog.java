...
public class DeviceAuthDialog extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        this.dialog = new Dialog(getActivity(), C0392R.style.com_facebook_auth_dialog);
    ...
    public View initializeContentView(boolean isSmartLogin) {
        ...
        if (isSmartLogin) {
            view = inflater.inflate(C0392R.layout.com_facebook_smart_device_dialog_fragment, null);
        } else {
            view = inflater.inflate(C0392R.layout.com_facebook_device_auth_dialog_fragment, null);
        }
        this.progressBar = (ProgressBar) view.findViewById(C0392R.C0394id.progress_bar);
        this.confirmationCode = (TextView) view.findViewById(C0392R.C0394id.confirmation_code);
        ((Button) view.findViewById(C0392R.C0394id.cancel_button)).setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                DeviceAuthDialog.this.onCancel();
            }
        });
        this.instructions = (TextView) view.findViewById(C0392R.C0394id.com_facebook_device_auth_instructions);
        this.instructions.setText(Html.fromHtml(getString(C0392R.string.com_facebook_device_auth_instructions)));
        return view;
    }
    ...
    public void presentConfirmation(final String userId, final PermissionsPair permissions, final String accessToken, String name) {
        String message = getResources().getString(C0392R.string.com_facebook_smart_login_confirmation_title);
        String continueFormat = getResources().getString(C0392R.string.com_facebook_smart_login_confirmation_continue_as);
        String cancel = getResources().getString(C0392R.string.com_facebook_smart_login_confirmation_cancel);
