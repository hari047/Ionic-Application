...
public class LoginFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(C0392R.layout.com_facebook_login_fragment, container, false);
        final View progressBar = view.findViewById(C0392R.C0394id.com_facebook_login_fragment_progress_bar);
    ...
    public void onPause() {
        ...
        if (getView() == null) {
            ...
            progressBar = getView().findViewById(C0392R.C0394id.com_facebook_login_fragment_progress_bar);
        }
        if (progressBar != null) {
            progressBar.setVisibility(8);
        }
