...
import com.facebook.login.C0461R;
...
public class LoginButton extends FacebookButtonBase {
    ...
    protected class LoginClickListener implements OnClickListener {
        ...
        public void performLogout(Context context) {
            ...
            if (LoginButton.this.confirmLogout) {
                String logout = LoginButton.this.getResources().getString(C0461R.string.com_facebook_loginview_log_out_action);
                String cancel = LoginButton.this.getResources().getString(C0461R.string.com_facebook_loginview_cancel_action);
                Profile profile = Profile.getCurrentProfile();
                if (profile == null || profile.getName() == null) {
                    message = LoginButton.this.getResources().getString(C0461R.string.com_facebook_loginview_logged_in_using_facebook);
                } else {
                    message = String.format(LoginButton.this.getResources().getString(C0461R.string.com_facebook_loginview_logged_in_as), new Object[]{profile.getName()});
                }
    ...
    private void checkToolTipSettings() {
        switch (this.toolTipMode) {
            case AUTOMATIC:
                ...
                return;
            case DISPLAY_ALWAYS:
                displayToolTip(getResources().getString(C0461R.string.com_facebook_tooltip_default));
                return;
            default:
                return;
        }
    ...
    public void configureButton(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        if (isInEditMode()) {
            setBackgroundColor(getResources().getColor(C0392R.color.com_facebook_blue));
        ...
        setButtonText();
        setCompoundDrawablesWithIntrinsicBounds(AppCompatResources.getDrawable(getContext(), C0461R.C0462drawable.com_facebook_button_login_logo), null, null, null);
    }
    ...
    public int getDefaultStyleResource() {
        return C0461R.style.com_facebook_loginview_default_style;
    }

    private void parseLoginButtonAttributes(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        this.toolTipMode = ToolTipMode.DEFAULT;
        TypedArray a = context.getTheme().obtainStyledAttributes(attrs, C0461R.styleable.com_facebook_login_view, defStyleAttr, defStyleRes);
        try {
            this.confirmLogout = a.getBoolean(C0461R.styleable.com_facebook_login_view_com_facebook_confirm_logout, true);
            this.loginText = a.getString(C0461R.styleable.com_facebook_login_view_com_facebook_login_text);
            this.logoutText = a.getString(C0461R.styleable.com_facebook_login_view_com_facebook_logout_text);
            this.toolTipMode = ToolTipMode.fromInt(a.getInt(C0461R.styleable.com_facebook_login_view_com_facebook_tooltip_mode, ToolTipMode.DEFAULT.getValue()));
        } finally {
            a.recycle();
        }
    }
    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (text == null) {
            text = resources.getString(C0461R.string.com_facebook_loginview_log_in_button_continue);
            int logInWidth = measureButtonWidth(text);
            if (resolveSize(logInWidth, widthMeasureSpec) < logInWidth) {
                text = resources.getString(C0461R.string.com_facebook_loginview_log_in_button);
            }
        }
        int logInWidth2 = measureButtonWidth(text);
        String text2 = this.logoutText;
        if (text2 == null) {
            text2 = resources.getString(C0461R.string.com_facebook_loginview_log_out_button);
        }
    ...
    public void setButtonText() {
        ...
        if (!isInEditMode() && AccessToken.isCurrentAccessTokenActive()) {
            if (this.logoutText != null) {
                ...
                string = resources.getString(C0461R.string.com_facebook_loginview_log_out_button);
            }
            setText(string);
        } else if (this.loginText != null) {
            setText(this.loginText);
        } else {
            String text = resources.getString(C0461R.string.com_facebook_loginview_log_in_button_continue);
            int width = getWidth();
