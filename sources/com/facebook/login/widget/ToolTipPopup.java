...
public class ToolTipPopup {
    ...
    private class PopupContentView extends FrameLayout {
        ...
        private void init() {
            LayoutInflater.from(getContext()).inflate(C0461R.layout.com_facebook_tooltip_bubble, this);
            this.topArrow = (ImageView) findViewById(C0461R.C0463id.com_facebook_tooltip_bubble_view_top_pointer);
            this.bottomArrow = (ImageView) findViewById(C0461R.C0463id.com_facebook_tooltip_bubble_view_bottom_pointer);
            this.bodyFrame = findViewById(C0461R.C0463id.com_facebook_body_frame);
            this.xOut = (ImageView) findViewById(C0461R.C0463id.com_facebook_button_xout);
        }
    ...
    public void show() {
        if (this.mAnchorViewRef.get() != null) {
            ...
            ((TextView) this.mPopupContent.findViewById(C0461R.C0463id.com_facebook_tooltip_bubble_view_text_body)).setText(this.mText);
            if (this.mStyle == Style.BLUE) {
                this.mPopupContent.bodyFrame.setBackgroundResource(C0461R.C0462drawable.com_facebook_tooltip_blue_background);
                this.mPopupContent.bottomArrow.setImageResource(C0461R.C0462drawable.com_facebook_tooltip_blue_bottomnub);
                this.mPopupContent.topArrow.setImageResource(C0461R.C0462drawable.com_facebook_tooltip_blue_topnub);
                this.mPopupContent.xOut.setImageResource(C0461R.C0462drawable.com_facebook_tooltip_blue_xout);
            } else {
                this.mPopupContent.bodyFrame.setBackgroundResource(C0461R.C0462drawable.com_facebook_tooltip_black_background);
                this.mPopupContent.bottomArrow.setImageResource(C0461R.C0462drawable.com_facebook_tooltip_black_bottomnub);
                this.mPopupContent.topArrow.setImageResource(C0461R.C0462drawable.com_facebook_tooltip_black_topnub);
                this.mPopupContent.xOut.setImageResource(C0461R.C0462drawable.com_facebook_tooltip_black_xout);
            }
