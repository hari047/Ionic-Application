...
public final class Profile implements Parcelable {
    ...
    public Uri getProfilePictureUri(int width, int height) {
        return ImageRequest.getProfilePictureUri(this.f19id, width, height);
    }
    ...
    public boolean equals(Object other) {
        ...
        if (!this.f19id.equals(o.f19id) || this.firstName != null) {
    ...
    public int hashCode() {
        int result = this.f19id.hashCode() + 527;
    ...
    Profile(JSONObject jsonObject) {
        Uri uri = null;
        this.f19id = jsonObject.optString("id", null);
