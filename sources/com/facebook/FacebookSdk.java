...
public final class FacebookSdk {
     ...
     */
    /* JADX WARNING: Exception block dominator not found, dom blocks: [B:2:0x0004, B:9:0x003b] */
    ...
    static void publishInstallAndWaitForResponse(android.content.Context r14, java.lang.String r15) {
        ...
        L_0x0004:
            java.lang.IllegalArgumentException r11 = new java.lang.IllegalArgumentException     // Catch:{ Exception -> 0x000d }
            java.lang.String r12 = "Both context and applicationId must be non-null"
            r11.<init>(r12)     // Catch:{ Exception -> 0x000d }
            throw r11     // Catch:{ Exception -> 0x000d }
        L_0x000d:
            r0 = move-exception
        ...
        L_0x0014:
            return
        L_0x0015:
            com.facebook.internal.AttributionIdentifiers r2 = com.facebook.internal.AttributionIdentifiers.getAttributionIdentifiers(r14)     // Catch:{ Exception -> 0x000d }
            java.lang.String r11 = "com.facebook.sdk.attributionTracking"
            r12 = 0
            android.content.SharedPreferences r6 = r14.getSharedPreferences(r11, r12)     // Catch:{ Exception -> 0x000d }
            java.lang.StringBuilder r11 = new java.lang.StringBuilder     // Catch:{ Exception -> 0x000d }
            r11.<init>()     // Catch:{ Exception -> 0x000d }
            java.lang.StringBuilder r11 = r11.append(r15)     // Catch:{ Exception -> 0x000d }
            java.lang.String r12 = "ping"
            java.lang.StringBuilder r11 = r11.append(r12)     // Catch:{ Exception -> 0x000d }
            java.lang.String r3 = r11.toString()     // Catch:{ Exception -> 0x000d }
            r12 = 0
            long r4 = r6.getLong(r3, r12)     // Catch:{ Exception -> 0x000d }
            com.facebook.appevents.internal.AppEventsLoggerUtility$GraphAPIActivityType r11 = com.facebook.appevents.internal.AppEventsLoggerUtility.GraphAPIActivityType.MOBILE_INSTALL_EVENT     // Catch:{ JSONException -> 0x0075 }
            java.lang.String r12 = com.facebook.appevents.AppEventsLogger.getAnonymousAppDeviceGUID(r14)     // Catch:{ JSONException -> 0x0075 }
            boolean r13 = getLimitEventAndDataUsage(r14)     // Catch:{ JSONException -> 0x0075 }
            org.json.JSONObject r7 = com.facebook.appevents.internal.AppEventsLoggerUtility.getJSONObjectForGraphAPICall(r11, r2, r12, r13, r14)     // Catch:{ JSONException -> 0x0075 }
            java.lang.String r11 = "%s/activities"
            r12 = 1
            java.lang.Object[] r12 = new java.lang.Object[r12]     // Catch:{ Exception -> 0x000d }
            r13 = 0
            r12[r13] = r15     // Catch:{ Exception -> 0x000d }
            java.lang.String r10 = java.lang.String.format(r11, r12)     // Catch:{ Exception -> 0x000d }
            r11 = 0
            r12 = 0
            com.facebook.GraphRequest r8 = com.facebook.GraphRequest.newPostRequest(r11, r10, r7, r12)     // Catch:{ Exception -> 0x000d }
            r12 = 0
            int r11 = (r4 > r12 ? 1 : (r4 == r12 ? 0 : -1))
            if (r11 != 0) goto L_0x0014
            com.facebook.GraphResponse r9 = r8.executeAndWait()     // Catch:{ Exception -> 0x000d }
            android.content.SharedPreferences$Editor r1 = r6.edit()     // Catch:{ Exception -> 0x000d }
            long r4 = java.lang.System.currentTimeMillis()     // Catch:{ Exception -> 0x000d }
            r1.putLong(r3, r4)     // Catch:{ Exception -> 0x000d }
            r1.apply()     // Catch:{ Exception -> 0x000d }
            goto L_0x0014
        L_0x0075:
            r0 = move-exception
            com.facebook.FacebookException r11 = new com.facebook.FacebookException     // Catch:{ Exception -> 0x000d }
            java.lang.String r12 = "An error occurred while publishing install."
            r11.<init>(r12, r0)     // Catch:{ Exception -> 0x000d }
            throw r11     // Catch:{ Exception -> 0x000d }
        */
