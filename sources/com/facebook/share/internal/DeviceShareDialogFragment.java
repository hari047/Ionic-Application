...
public class DeviceShareDialogFragment extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        View view = getActivity().getLayoutInflater().inflate(C0392R.layout.com_facebook_device_auth_dialog_fragment, null);
        ...
        ((TextView) view.findViewById(C0392R.C0394id.com_facebook_device_auth_instructions)).setText(Html.fromHtml(getString(C0392R.string.com_facebook_device_auth_instructions)));
